...
//rezerwa gracz
    ...
    $reserve_surname =  $_POST['reserve_surname'];

    $reserve_name->CharSet = "UTF-8";

    $reserve_surname->CharSet = "UTF-8";



    $reserve_email = $_POST['reserve_email'];

    $reserve_nick = $_POST['reserve_nick'];

    $reserve_class = $_POST['reserve_class'];
    ...
    $reserve_steam = $_POST['reserve_steam'];
    ...
    if($isTeamName == 0 && $isTeamTag == 0){
        ...
        if ($polaczenie->query("INSERT INTO gamers VALUES (NULL, '$reserve_name', '$reserve_surname', '$reserve_email', '$reserve_nick', '$reserve_class', '$reserve_steam', '$teamid')")){
